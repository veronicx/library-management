                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-10 offset-1">
                                ...
                                <form method="post" @submit.prevent="editMembership">
    ...
    export default {
        ...
        methods: {
            ...
            async fetchMembership(){
                const response = await axios.get(`http://localhost:8000/api/membership/${this.membershipId}`)
                this.selectedUserType = response.data.userType
